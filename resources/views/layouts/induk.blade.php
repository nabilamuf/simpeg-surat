  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item " data-toggle="tooltip" data-placement="right" title="Tampilan Data Pegawai!">
        <div class="shadow-lg m-2 bg-light">
          <a class="nav-link collapsed text-dark" href="#" data-toggle="collapse" data-target="#collapsePagesPNS"
          aria-expanded="true" aria-controls="collapsePages">
          {{-- <a class="nav-link collapsed text-dark" href="/list"> --}}
            <i class="fas fa-users text-dark"></i>
            <span> Data Pegawai PNS</span>
          </a>
          <div id="collapsePagesPNS" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="/list/pns">PNS</a>
              <h6 class="collapse-header">cetak surat :</h6>
              <a class="collapse-item" href="/pegawai/tmagama/tambah"> Surat Cuti</a>
              <a class="collapse-item" href="/surat_rekom/pns"> Surat Rekomendasi</a>
              <a class="collapse-item" href="/pegawai/tmdiklat/tambah"> SPMT</a>
      ...
      <li class="nav-item " data-toggle="tooltip" data-placement="right" title="Tampilan Data Pegawai!">
        <div class="shadow-lg m-2 bg-light">
          <a class="nav-link collapsed text-dark" href="#" data-toggle="collapse" data-target="#collapsePagesP3K"
          aria-expanded="true" aria-controls="collapsePages">
          {{-- <a class="nav-link collapsed text-dark" href="/list"> --}}
            <i class="fas fa-users text-dark"></i>
            <span> Data Pegawai P3K</span>
          </a>
          <div id="collapsePagesP3K" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <h6 class="collapse-header">pegawai :</h6>
              <a class="collapse-item" href="/list/p3k">P3K</a>
              <h6 class="collapse-header">cetak surat :</h6>
              <a class="collapse-item" href="/pegawai/tmagama/tambah"> Surat Cuti</a>
      ...
      <li class="nav-item " data-toggle="tooltip" data-placement="right" title="Tampilan Data Pegawai!">
        <div class="shadow-lg m-2 bg-light">
          <a class="nav-link collapsed text-dark" href="#" data-toggle="collapse" data-target="#collapsePageskontrak"
          aria-expanded="true" aria-controls="collapsePages">
          {{-- <a class="nav-link collapsed text-dark" href="/list"> --}}
            <i class="fas fa-users text-dark"></i>
            <span> Data Pegawai Kontrak</span>
          </a>
      ...
      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tampilan tentang Data master!">
        <div class="shadow-lg m-2 bg-light">
          <a class="nav-link collapsed text-dark" href="#" data-toggle="collapse" data-target="#collapsePagess"
          ...
          <div id="collapsePagess" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="/pegawai/tmagama/tambah">Jabatan</a>
